<?php
class dhc_Categories extends WP_Widget {
    /**
    ...
    function __construct() {
        ...
        parent::__construct(
            'widget_categories',
            esc_html__( 'dhc - Categories', 'dhc' ),
            array(
                'classname'   => 'widget_categories',
                'description' => esc_html__( 'Categories.', 'dhc' )
            )
        );
    }
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'custom_ids' ) ); ?>"><?php esc_html_e( 'Custom Categories By Ids- EX: 1,2,3', 'dhc' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'child_of' ) ); ?>"><?php esc_html_e( 'Child Of:', 'dhc' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_count' ) ); ?>"><?php esc_html_e( 'Show count?', 'dhc' ); ?></label>
        </p>
...
add_action( 'widgets_init', 'dhc_register_categories' );
 ...
 * @since 1.0
 */
function dhc_register_categories() {
