<?php
if (  dhc_choose_opt( 'show_related_portfolio') != 1)
	return;
$atts = array(
	'style'           => dhc_choose_opt( 'related_portfolio_style' ),
	'columns'         => dhc_choose_opt( 'grid_columns_portfolio_related' ),
	'limit'           => (int) dhc_choose_opt( 'number_related_portfolio'),
	'content_length'  => 150,
	'show_filter'     => 'no'
);
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				echo dhc_VCExtend::dhc_portfolio( $atts );
				?>
			</div>
		</div>
	</div>
